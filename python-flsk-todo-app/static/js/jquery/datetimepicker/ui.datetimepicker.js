...
$.extend(Timepicker.prototype, {
	...
	_onTimeChange: function() {
		...
		var timeObj = {hour:hour,minute:minute,second:second}; //added by peter
		this._formatTime(timeObj);//modified by peter
	...
	_formatTime: function(time, format, ampm) {
		...
		if (arguments.length>1) return tmptime; //modified by peter
	...
	_updateDateTime: function(dp_inst) {
		...
		//Peter modifies
		//dt = $.datepicker.parseDate(dateFmt,(dp_inst.input ? dp_inst.input.val() : null));
		dt = new Date(dt.getFullYear(), dt.getMonth(), dt.getDate());
		this.formattedDate = $.datepicker.formatDate(dateFmt, dt, formatCfg);
		//end of modiying
