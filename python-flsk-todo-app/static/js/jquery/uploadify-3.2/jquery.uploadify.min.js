...
*/
/**
 * James Chen 2697 102/07/17 更新註解
 * 弱點掃描報告建議修改事項：
 * 有可能竊取或操作客戶階段作業和 Cookie，其可能用來假冒合法的使用者，
 * 讓駭客可以檢視或變更使用者記錄，以及以該使用者的身分來執行交易
 * Flash 參數 AllowScriptAccess 設為 always 是不安全的 Web 應用程式設計或配置
 * 建議修正為：'sameDomain' 僅讓同網域呼叫
 */
